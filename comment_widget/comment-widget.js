/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/comment_widget/comment-widget.js"></script>
...
const s_stylePath = '/comment_widget/comment-widget-dark.css';
const s_formId = '1FAIpQLSfN1LTjoYdGZH80IVW9ImbLyhLXnfSogN6PB1ABLnKX-942tg'; // The Google Form
const s_nameId = '1518912291'; // The Name field ID
const s_websiteId = '1481920820'; // The Website field ID
const s_textId = '1552877654'; // The Text field ID
const s_pageId = '980523615'; // The Page field ID
const s_replyId = '1668551846'; // The Reply field ID
const s_sheetId = '1dNTqD-KUnkzf5lPhuYxbtjSEB2xy5Zml_h8fxMWDXD4'; // The Google Sheet
